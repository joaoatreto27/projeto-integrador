<?php 
    ...
    if ((!isset($_SESSION['email']) === true) and (!isset($_SESSION['senha']) === true)) {
        ...
        if (isset($_SESSION['carrinho_serializado'])) {
            $carrinhoFinal = unserialize($_SESSION['carrinho_serializado']);
        } else {
            $carrinhoFinal = array();
        }
        ...
        if(!empty($_GET['id'])){
            ...
            $sql = "SELECT * FROM produtos WHERE id_mercados = $idMercado";
        ...
        function redirecionarFinalizarCarrinho($carrinhoFinal)
        {
            $carrinho_serializado = serialize($carrinhoFinal);
            $url = "finalizar_carrinho.php?carrinho=" . urlencode($carrinho_serializado);
            header("Location: $url");
            exit();
        }
        
        if (isset($_POST['finalizar_compra'])) {
            redirecionarFinalizarCarrinho($carrinhoFinal);
        }
    }
    ...
    <main>
        <div class="produtos-card">
            <div class="categorias">
                <a href="./mercado.php?id=1" class="btn-categorias selecionado">
                ...
                <a href="./mercado-bebidas.php?id=1" class="btn-categorias">
                ...
                <div class="produtos">
                        ...
                        while($user_data = mysqli_fetch_assoc($result)){
                            echo "<div class='produtos-img'>";
                                ...
                                echo '<form method="POST" action="carrinho.php">';
                                    ...
                                    echo '<input type="number" name="quantidade" min=1 value=1>';
                    ...
                    <div class="carrinho-de-compras">
                                ...
                                $total = 0;
                                    ...
                                    foreach ($_SESSION['carrinho'] as $produto) {
                                        echo '<div class="produto-carrinho">';
                                            ...
                                            echo '<p class="valor-produto">R$ ' . $produto['valor'] * $produto['quantidade'] . '</p>';
                                            ...
                                            echo '</form>';
                                        echo '</div>';
                                        $totalProduto = $produto['valor'] * $produto['quantidade'];
                                        $total += $totalProduto;
                                    }
                                }
                            ?>
                        ...
                        <div class="footer-carrinho">
                            ...
                            if (!empty($_SESSION['carrinho'])){
                                    echo 
                                        '<form class="form-finalizar" method="POST" action="mercado.php">
                                            <button type="submit" class="finalizar-btn" name="finalizar_compra">Finalizar Compra</button>
                                        </form>
