<?php 
    ...
    if(!empty($_GET['search'])){
        ...
        $data = $_GET['search'];
        $sql = "SELECT * FROM endereco_cliente WHERE cidade LIKE '%$data%' 
            or uf LIKE '%$data%'
                or id_clientes LIKE '%$data%' ORDER BY id_endereco DESC";
...
<script>
    ...
    function searchData() {
        ...
        window.location = 'enderecos_administrador.php?search='+search.value;
    }
