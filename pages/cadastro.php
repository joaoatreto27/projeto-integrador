<?php
    ...
    if(isset($_POST['submit'])){
        ...
        if($enviar){
            ...
            "INSERT INTO mercados(nome, cnpj, inscricao_estadual, email, telefone, senha, cidade, 
                numero, cep, uf, bairro, rua, path, nome_imagem)
            VALUES ('$nome', '$cnpj', '$inscricao_estadual', '$email', '$telefone', '$senha', '$cidade', 
                '$numero', '$cep', '$uf', '$bairro',  '$rua', '$path', '$nomeArquivo')");
        }
