<?php 
    ...
    if(!empty($_GET['search'])){
        ...
        $data = $_GET['search'];
        $sql = "SELECT * FROM clientes WHERE nome LIKE '%$data%' 
            or email LIKE '%$data%' ORDER BY id_clientes DESC";
...
<script>
    ...
    function searchData() {
        ...
        window.location = 'clientes_administrador.php?search='+search.value;
    }
